...
export const getLogs = (req: Request, res: Response, next: NextFunction) => {
  const requestQuery: IPaginationParams =
    req.query as unknown as IPaginationParams;
...
//   const requestBody: IPaginationParams =
//     req.body as unknown as IPaginationParams;
...
//     .status(300)
//     .redirect(
//       `/api/log?from=${fromDate}&to=${toDate}&page=${page}&limit=${limit}`
//     );
// };
